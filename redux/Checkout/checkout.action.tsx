...
export const inputValidation = (data:any) => async (dispatch:any)=> {
    ...
    //***********DEV/TESTING PURUPOSE!, DO NOT USE THIS FOR POST-PRODUCTION BUILD!!*************
    ...
    let valid = false
    const validObjArr = [ 
        {name :"Card number",value:"",valid:false,maxlength:"15",minlength:"15",isNum:true},
        {name :"CVC code",value:"",valid:false,maxlength:"3",minlength:"3",isNum:true},
        {name :"Card holder name",value:"",valid:false,maxlength:"1",minlength:"30",isNum:false},
        {name :"Expire date",value:"",valid:false,maxlength:"6",minlength:"6",isNum:true},
        {name :"Last name",value:"",valid:false,maxlength:"1",minlength:"30",isNum:false},
        {name :"Street Address",value:"",valid:false,maxlength:"1",minlength:"20",isNum:false},
        {name :"PostCode",value:"",valid:false,maxlength:"4",minlength:"4",isNum:true},
        {name :"Email",value:"",valid:false,maxlength:"1",minlength:"20",isNum:false},
        {name :"Phone",value:"",valid:false,maxlength:"1",minlength:"10",isNum:true},
    ]
